...
internal enum Asset {
  ...
  internal static let cancelMenu = ImageAsset(name: "cancel_menu")
  ...
  internal static let reportMenu = ImageAsset(name: "report_menu")
  internal static let reviewMenu = ImageAsset(name: "review_menu")
